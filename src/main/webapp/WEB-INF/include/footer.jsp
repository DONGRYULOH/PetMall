				  ...
				  <div _ngcontent-c2="" class="row align-items-center justify-content-md-between">
					  <div _ngcontent-c2="" class="col-md-6">
					  	<div _ngcontent-c2="" class="copyright"> © 2021 
					  		<a _ngcontent-c2="" href="https://www.creative-tim.com?ref=adsa-footer" target="_blank">Creative WooDong</a>. 
					    </div>
					  </div>
					  <div _ngcontent-c2="" class="col-md-6">
						  <ul _ngcontent-c2="" class="nav nav-footer justify-content-end">
							  <li _ngcontent-c2="" class="nav-item">
							  	<a _ngcontent-c2="" class="nav-link" href="https://www.creative-tim.com?ref=adsa-footer" target="_blank">회사소개</a>
							  </li>
						  	  <li _ngcontent-c2="" class="nav-item">
						  		<a _ngcontent-c2="" class="nav-link" href="https://www.creative-tim.com/presentation?ref=adsa-footer" target="_blank">이용약관</a>
						  	  </li>
						 	  <li _ngcontent-c2="" class="nav-item">
						 	  	<a _ngcontent-c2="" class="nav-link" href="http://blog.creative-tim.com?ref=adsa-footer" target="_blank">개인정보취급방침</a>
						 	  </li>
						  	  <li _ngcontent-c2="" class="nav-item">
						  	  	<a _ngcontent-c2="" class="nav-link" href="https://github.com/creativetimofficial/argon-design-system-angular/blob/master/LICENSE.md" target="_blank">견적문의</a>
						  	  </li>
						  </ul>
					  </div>
				  </div>
