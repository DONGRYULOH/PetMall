	...
	<%@ include file="/WEB-INF/views/admin/include/admin_sidenav.jsp"%>
  	...
  	<div class="main-content" id="panel">
		    ...
		    <form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="inputArea">
					 ...
					 <div class="select_img">
						  <img src="${pageContext.request.contextPath}/imgUpload${product.product_image}" />
						  <input type="hidden" name="product_image" value="${product.product_image}" />
						  <input type="hidden" name="product_ThumbImg" value="${product.product_ThumbImg}" /> 
					 </div>
				</div>
				<!-- 저장되는 파일 실제경로 추출하기 -->
				<%=request.getRealPath("/") %>
    	...
    	<script>
	    	...
	    	var select_cateCode = '${product.product_category}';
	    	var select_cateCodeRef = '${product.category_code_ref}';
		...
		<script>
			 ...
			 $("#back_Btn").click(function(){
				  ...
				  history.back();
				  /* 
				  formObj.attr("action", "${pageContext.request.contextPath}/admin/goods_detail?n=" + ${product.product_number});
				  formObj.attr("method", "get");
				  formObj.submit(); 
				  */
				  //location.href = "${pageContext.request.contextPath}/admin/goods_detail?n=" + ${product.product_number};
			 });   
		</script>
